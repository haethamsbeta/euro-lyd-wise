    ...
    <NotificationsProvider>
      <TooltipProvider delayDuration={150}>
        <div className="min-h-screen bg-background">
          ...
          <header
            dir="ltr"
            className="sticky top-0 z-40 w-full border-b border-gold/20 bg-card/90 shadow-[0_4px_24px_-12px_oklch(0.18_0.02_70/0.6)] backdrop-blur-xl relative"
            style={{ paddingTop: "env(safe-area-inset-top)" }}
          >
            <div
              className="flex h-16 w-full items-center gap-1 px-2.5 sm:h-[68px] sm:gap-3 sm:px-5 lg:h-[72px] lg:px-8"
              style={{
