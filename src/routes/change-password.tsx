...
function ChangePasswordPage() {
  ...
  useEffect(() => {
    if (!loading && !session) nav({ to: "/login", search: { portal: "staff" } as any });
  }, [loading, session, nav]);
      ...
      <div className="w-full max-w-md space-y-5">
        ...
        <Card className="card-luxe rounded-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>An admin requires you to set a new password before continuing.</CardDescription>
          </CardHeader>
          <CardContent>
